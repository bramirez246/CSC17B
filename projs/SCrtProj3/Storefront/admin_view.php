...
<html>
    ...
    <body>
        ...
        $sql = "SELECT  `user_id` FROM `bramirez246_48947`.`user_entity` AS `user_entity`";
        // access the database
        ...
        // Define the query:
        $sql = "SELECT  `user_id`, `first_name`, `last_name`, `email`, `password` FROM `bramirez246_48947`.`user_entity` AS `user_entity` ORDER BY `".$sort."` LIMIT ".$start.", ".$display."";
